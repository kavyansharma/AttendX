...
export const Hero: React.FC<HeroProps> = ({ onOpenDemo, onOpenLogin }) => {
  return (
    <section className="relative py-10 lg:py-16 bg-slate-950 overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-600/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute top-1/2 right-10 -translate-y-1/2 w-[350px] h-[350px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
              <button
                onClick={onOpenDemo}
                className="btn btn-primary py-3 px-6 text-sm font-bold shadow-xl shadow-indigo-600/25"
              >
              ...
              <a
                href="#demo-live"
                className="btn btn-secondary py-3 px-5 text-sm font-semibold border-slate-800 text-center"
              >
          ...
          {/* Right Column: Contained Live Dashboard Preview */}
